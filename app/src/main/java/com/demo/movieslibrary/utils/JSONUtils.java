package com.demo.movieslibrary.utils;
    ...
    public static ArrayList<Movie> getMovieFromJSON(JSONObject jsonObject) {
        ...
        try {
            ...
            for (int i = 0; i < jsonArray.length(); i++) {
                ...
                double averageVote = objectMovie.getDouble(KEY_VOTE_AVERAGE);
                String releaseDate = objectMovie.getString(KEY_RELEASE_DATE);
                Movie movie = new Movie(id, voteCount, title, originalTitle, overview, posterPath, bigPosterPath, backdropPath, averageVote, releaseDate);
                result.add(movie);
            }
